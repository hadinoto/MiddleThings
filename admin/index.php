...
?>
    ...
    <head>
        ...
        <title>Admin Middlethings</title>
    ...
    <body id="page-top">
        ...
        <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <!-- Sidebar - Brand -->
                <a class="sidebar-brand d-flex align-items-center justify-content-center" href="?hal=dashboard">
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseData" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <a class="collapse-item" href="?hal=data_admin">Admin</a>
                            <a class="collapse-item" href="?hal=data_member">Member</a>
                        </div>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseProduct" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="?hal=product_household">Household</a>
                            <a class="collapse-item" href="?hal=product_stationary">Stationary</a>
                            <a class="collapse-item" href="?hal=product_wearable">Wearable</a>
                        </div>
                    </div>
                </li>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <a class="btn btn-primary" href="../command/selesai_session.php">Logout</a>
                    </div>
                </div>
            </div>
        </div>
